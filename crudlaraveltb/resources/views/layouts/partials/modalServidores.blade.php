...
<body>
    ...
    <!-- Modal -->
    <div class="modal fade" id="ServidorModal" tabindex="-1" role="dialog" aria-labelledby="ServidorModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ServidorModalLabel">Gerar Chave Única</h5>
                    <button type="button" onclick="submitForm()" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="contractNumberInput"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="submitForm()" data-dismiss="modal">Fechar</button>
                    <button type="button" class="btn btn-primary" onclick="generateUniqueKey()">Gerar Chave
                        Única</button>
    ...
    <script>
        ...
        function submitForm() {
            ...
            const ServidorModal = bootstrap.Modal.getInstance(document.getElementById('ServidorModal'));
