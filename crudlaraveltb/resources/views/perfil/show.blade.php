        ...
        <div class="d-flex">
            ...
            <div class="infoPes border border-dark border-1 m-3 rounded">
                <button class="border border-dark border-2 rounded m-1 botaoPerf"
                    onclick="showContent('personalInfo')">Informações Pessoais</button>
                <button class="border border-dark border-2 rounded m-1 botaoPerf"
                    onclick="showContent('ocorrencias1')">Ocorrências Feitas</button>
                <button class="border border-dark border-2 rounded m-1 botaoPerf"
                    onclick="showContent('enf')">Relatórios Enfermaria</button>
                ...
                <div id="editForm" class="content mt-3" style="display: none;">
                    <form method="POST" action="{{ route('perfil.update', $user->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="telefone_pais" value="{{ $user->telefone_pais }}"
                                class="form-control">
                        </div>
