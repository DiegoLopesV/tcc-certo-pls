    ...
    @foreach ($enfermaria as $item)
        <div class="card">
            <div class="card-header">
                ...
                <div><strong>Hora Início:</strong> {{ $item->horaInicio }}</div>
                <div><strong>Hora Final:</strong> {{ $item->horaFinal }}</div>
                <div><strong>Responsável:</strong> {{ $item->responsavel }}</div>
                <div><strong>Idade:</strong> {{ $item->idade }}</div>
                <div><strong>Queixa:</strong> {{ $item->queixa }}</div>
                <div><strong>Atividade realizada:</strong> {{ $item->atividade_realizada }}</div>
                <div><strong>Conduta:</strong> {{ $item->conduta }}</div>
